...
void MillePedeAlignmentAlgorithm::initialize(const edm::EventSetup &setup,
                                             ...
                                             AlignmentParameterStore *store, edm::ConsumesCollector &iC) {
  if (muon) {
...
//____________________________________________________
void MillePedeAlignmentAlgorithm::run(const edm::EventSetup &setup, const EventInfo &eventInfo,edm::ConsumesCollector &iC) {
  if (!this->isMode(myMilleBit))
